...
local on_attach = function(client, bufnr)
  ...
  --   vim.api.nvim_exec([[
  --     hi LspReferenceRead cterm=bold ctermbg=yellow guibg=blue
  --     hi LspReferenceText cterm=bold ctermbg=yellow guibg=blue
  --     hi LspReferenceWrite cterm=bold ctermbg=yellow guibg=blue
...
local servers = { "clangd", "cmake", "pyls", "rls", "vimls"}
